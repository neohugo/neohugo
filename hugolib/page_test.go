...
func TestPageWithLastmodFromGitInfo(t *testing.T) {
	...
	// 2020-10-19 is the Git author date for testsite/content/first-post.md
	c.Assert(enSite.RegularPages()[0].Lastmod().Format("2006-01-02"), qt.Equals, "2020-10-19")

	nnSite := h.Sites[1]
	c.Assert(len(nnSite.RegularPages()), qt.Equals, 1)

	// 2020-10-19 is the Git author date for testsite/content_nn/first-post.md
	c.Assert(nnSite.RegularPages()[0].Lastmod().Format("2006-01-02"), qt.Equals, "2020-10-19")
