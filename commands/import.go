...
func (c *importCommand) createSiteFromJekyll(jekyllRoot, targetDir string, jekyllPostDirs map[string]bool) error {
	...
	c.createConfigFromJekyll(fs, targetDir, "yaml", jekyllConfig) // nolint

	c.copyJekyllFilesAndFolders(jekyllRoot, filepath.Join(targetDir, "static"), jekyllPostDirs) // nolint
