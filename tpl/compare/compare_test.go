...
func doTestCompare(t *testing.T, tp tstCompareType, funcUnderTest func(a, b interface{}) bool) {
	for i, test := range []struct {
		...
		{neohugo.MustParseVersion("0.32.1").Version(), neohugo.MustParseVersion("0.32").Version(), 1},
		{neohugo.MustParseVersion("0.35").Version(), neohugo.MustParseVersion("0.32").Version(), 1},
		{neohugo.MustParseVersion("0.36").Version(), neohugo.MustParseVersion("0.36").Version(), 0},
		{neohugo.MustParseVersion("0.32").Version(), neohugo.MustParseVersion("0.36").Version(), -1},
		{neohugo.MustParseVersion("0.32").Version(), "0.36", -1},
		{"0.36", neohugo.MustParseVersion("0.32").Version(), 1},
		{"0.36", neohugo.MustParseVersion("0.36").Version(), 0},
		{"0.37", neohugo.MustParseVersion("0.37-DEV").Version(), 1},
